...
public class OverlapTest {
	...
	public static boolean pointInCircle(Circle c,Vector2 v){
		return c.center.distSquared(v) < c.radius * c.radius;
	}
	public static boolean pointInCircle(Circle c,float x,float y){
		return c.center.distSquared(x,y) < c.radius * c.radius;
	}
	
	public static boolean pointInRectangle(Rectangle r,Vector2 v){
